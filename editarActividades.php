...
if($_FILES['imagenActividad']['tmp_name']!= ""){
    ...
    $sqlChangeAvatar="UPDATE actividades SET nombre='$nombreActividad', foto='$fotoFinal',clase='$claseActividad',subclase='$subClaseActividad',descripcion='$descripcionActividad' where id= '$idActividad'";
