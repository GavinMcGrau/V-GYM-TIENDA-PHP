...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2021 a las 23:01:57
...
-- Base de datos: `gym`
--
CREATE DATABASE IF NOT EXISTS `gym` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci;
USE `gym`;
...
CREATE TABLE `actividades` (
  ...
  `hecha` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL DEFAULT 'no',
  `idUsuario` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
...
(35, 'Fondos de triceps', 'https://as01.epimg.net/deporteyvida/imagenes/2017/08/06/portada/1502014266_073304_1502014358_noticia_normal.jpg\r\n', 'Tren Superior', 'Triceps', 'https://www.youtube.com/embed/PYapgguXgT8', 'no', '', 2, 23, 'miercoles');
...
CREATE TABLE `usuario` (
  ...
  `contrasenya` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
  `correo` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
  `rol` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL DEFAULT 'users',
